<template>
  <div id="fourth-step">
    ...
    <div class="form-content" justify="center" align-content="center" v-for="FourthStepValue in FourthStepValues" v-bind:key="FourthStepValue.title">
      ...
      <div class="form-content-detail">
        ...
        <validation-provider
          ...
          rules="required"
        >
        <v-radio-group class="form-content-radio" :name="FourthStepValue.name" v-model="FourthStepValue.saveValue" color="info">
